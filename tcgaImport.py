...
class TCGAClinicalImport2(FileImporter):
    ...
    @staticmethod
    def getOutputList():
        return ["patient", "aliquot", "analyte", "portion", "sample", "drugs", "radiation"]
        ...
        for node in dom.childNodes[0].childNodes:
            if node.nodeType == node.ELEMENT_NODE and node.localName == 'patient':
                for samples in node.childNodes:
                    ...
                    elif samples.nodeType == samples.ELEMENT_NODE and samples.localName == 'follow_ups':
                        for follows in samples.childNodes:
                            if follows.nodeType == samples.ELEMENT_NODE:
                                print follows.localName
                    elif samples.nodeType == samples.ELEMENT_NODE:
                        #print "skipped", samples.localName
                        pass
